  ...
  return (
    <div className="max-w-2xl w-full mx-4 md:mx-auto rounded-xl sm:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black border">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Have a question? Send us a message and we will get back to you as soon as possible.
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          ...
          <LabelInputContainer>
            ...
            <Input id="lastname" placeholder="Dela Cruz" type="text" />
          </LabelInputContainer>         
        </div>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="subject">Subject</Label>
            <Input id="subject" placeholder="An inquiry about your service" type="text" />
          </LabelInputContainer>
        </div>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            <Label htmlFor="message">Message</Label>
            <Textarea id="message" placeholder="I would like to grab a website..." />
          </LabelInputContainer>
        </div>
        <button
