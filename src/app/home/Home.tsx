...
export default function Home() {
  return (
    <div>
      <div className="h-[71rem] md:h-[45rem] w-full relative flex items-start justify-center bg-white dark:bg-black bg-grid-black/[0.1] dark:bg-grid-white/[0.1]">
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
        <div className="flex justify-center items-center mt-16 px-6"> 
          <div className="h-[85rem] md:h-[46rem] w-full max-w-[95rem] z-20 pb-20 pt-[3rem] sm:pt-[2rem] md:pt-[4rem] px-2 sm:px-8 md:px-7 grid grid-cols-1 xl:grid-cols-2 items-start">
            <div className="grid grid-cols-1 items-center justify-center pt-0 md:pt-[4rem]" style={{height: '200px'}}>
