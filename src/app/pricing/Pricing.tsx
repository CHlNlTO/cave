  ...
  return (
    <main className="pt-40 bg-white dark:bg-black -z-20">
      <div className="flex justify-center items-center">
        <h1 className="flex justify-center items-center text-4xl sm:text-7xl md:text-7xl text-center max-w-3xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-gray-900 to-gray-900 py-8 dark:text-white">
          Find a plan to deploy your business online
        </h1>
      </div>
      <section className="h-[500px] w-full bg-gradient-to-r from-gray-50 to-gray-100 dark:from-black dark:to-neutral-950 flex items-center justify-center">
