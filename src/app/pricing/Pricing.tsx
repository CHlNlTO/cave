        ...
        <div className="container px-4 md:px-6 mb-20">
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
            <div className="flex flex-col p-12 gap-16 lg:gap-20 max-w-sm bg-white dark:bg-black shadow-lg rounded-lg dark:bg-zinc-850 border border-zinc-700 z-20">
              <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-1">
                  ...
                  <h1 className="text-sm text-start text-black dark:text-zinc-400">You choose, we maintain.</h1>
                </div>
              ...
              <div className="mt-6">
                <Button className="w-full border border-black rounded-md text-black hover:bg-black hover:text-white dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-black">Get Started &rarr;</Button>
              </div>
            </div>
            <motion.div
              style={{
            ...
            >
              ...
              <div className="relative flex flex-col p-12 gap-16 lg:gap-20 max-w-sm bg-white dark:bg-black shadow-lg rounded-lg dark:bg-zinc-850 border border-zinc-700 z-20">
                ...
                <div className="flex flex-col gap-12 relative">
                  <div className="flex flex-col gap-1">
                    <h3 className="text-xl font-bold text-start text-black dark:text-white">Pro</h3>
                    <div className="text-start text-black dark:text-white">
                      <span className="text-4xl font-bold">₱2648</span>/ month
                    </div>
                    <h1 className="text-sm text-start text-black dark:text-zinc-400">Everything in Basic, with more features.</h1>
                  </div>
                  <ul className="space-y-3 h-[150px]">
                    <li className="flex items-center">
                      <CheckIcon className="w-4 h-4 text-white dark:text-black bg-black dark:bg-white rounded-full mr-2 p-1" />
                ...
                <div className="mt-6">
                  <Button className="w-full border rounded-md bg-black hover:border-black dark:bg-white text-white hover:bg-white hover:text-black dark:border-black dark:text-black dark:hover:bg-black dark:hover:text-white dark:hover:border-white">Upgrade Now &rarr;</Button>
                </div>
              </div>
              </div>
            </motion.div>
            <div className="flex flex-col p-12 gap-16 lg:gap-20 max-w-sm bg-white dark:bg-black shadow-lg rounded-lg dark:bg-zinc-850 border border-zinc-700 z-20">
              <div className="flex flex-col gap-12">
                <div className="flex flex-col gap-1">
                  <div className="flex flex-row items-end gap-1">
                    <h3 className="text-xl font-bold text-start text-black dark:text-white">Custom</h3>
                    <h1 className="text-sm text-start text-black dark:text-zinc-400 pb-[3px]">starts at</h1>
                  </div>
                  <div className="text-start text-black dark:text-white">
                    <span className="text-4xl font-bold">₱49,298</span>
                  </div>
                  <h1 className="text-sm text-start text-black dark:text-zinc-400">For businesses with more versatile needs.</h1>
                </div>
                <ul className="space-y-3 h-[150px]">
                  <li className="flex items-center">
                    <CheckIcon className="w-4 h-4 text-white dark:text-black bg-black dark:bg-white rounded-full mr-2 p-1" />
              ...
              <div className="mt-6">
                <Button className="w-full border border-black rounded-md text-black hover:bg-black hover:text-white dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-black">Contact Sales</Button>
              </div>
            </div>
          </div>
        </div>
